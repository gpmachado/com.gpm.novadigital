...
class NovaDigitalSwitch2GangTouchDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('novadigital_switch_2_gang_touch_set_backlight')
      .registerRunListener(async args => args.device._onSettingBacklight(args.state === 'on'));

    this.homey.flow.getConditionCard('novadigital_switch_2_gang_touch_backlight_is_on')
